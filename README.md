...
TRIP_PROJECT_CODE='换成你的项目口令' TRIP_ADMIN_PASSWORD='换成至少12位的管理员密码' python3 server.py
```
...
- 项目口令可自由设置为 1–200 个字符，不要求字母、数字组合；后台留空表示不修改。公网使用仍建议设置较长且不易猜测的口令。管理员密码仍至少 12 位。
